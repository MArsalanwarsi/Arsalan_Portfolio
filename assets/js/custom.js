...
(function($){ 
    ...
    * Masonry
    ...
    WEA.masonry = function () {
      ...
      if ($(".portfolio-content").exists()){
        loadScript('https://unpkg.com/isotope-layout@3/dist/isotope.pkgd.js', function() {
          if ($(".portfolio-content").exists()){
  ...
  /*--------------------
    ...
    WEA.mTypeIt = function() {
      if ($("#type-it").exists()){
            loadScript('https://cdn.jsdelivr.net/npm/typeit@6.1.1/dist/typeit.min.js', function() {
                new TypeIt('#type-it', {
                speed: 100,
                loop:true,
                strings: [
